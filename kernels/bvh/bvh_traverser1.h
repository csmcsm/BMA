  ...
  namespace isa
  {
    ...
    public:
      ...
      static __forceinline void traverseClosestHit(NodeRef& cur,
        ...
        StackItemT<NodeRef>* stackEnd, StackDepth& sd)
      {
        size_t curPtr = cur.ptr;
        assert(mask != 0);
